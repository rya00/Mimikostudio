...
function ProductScreen() {
  ...
  return (
    <div>
      <Link to="/" className="btn btn-light my-3 go-back-btn">
      ...
      {loading ? (
        ...
        <div>
              ...
              <Card>
                <ListGroup variant="flush">
                  ...
                  {product.countInStock > 0 && (
                    <ListGroup.Item>
                      <Row>
                        <Col className="qty-container">Quantity: </Col>
                        {/* Creating Form */}
                        <Col xs="auto" className="my-1 qty-counter-shell">
                          <Form.Control
                            as="select"
                            value={qty}
          ...
          <Row>
            <Col md={6}>
              <h4 style={{marginTop: 35}}>Reviews</h4>
