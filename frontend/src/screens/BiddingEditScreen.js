...
function BiddingEditScreen() {
  ...
  return (
    <div>
      <Link to="/admin/biddinglist" className="btn btn-light go-back-btn">
        <IoIosArrowBack size={20} />
        Go Back
      </Link>
      <FormContainer>
        <h1 className="auto-underline-animation"> Edit Bidding</h1>
        ...
        {loading ? (
          ...
          <Form onSubmit={submitHandler}>
            <Form.Group className="grp-fields" controlId="biddingname">
            ...
            <Form.Group className="grp-fields" controlId="minimumprice">
              ...
              ></Form.Control>
              {minimumPriceError && (
                <Message variant="danger">{minimumPriceError}</Message>
              )}
            </Form.Group>
            ...
            <Form.Group className="grp-fields" controlId="enddate">
              ...
              ></Form.Control>
              {endTimeError && (
                <Message variant="danger">{endTimeError}</Message>
              )}
            </Form.Group>

            <Form.Group className="grp-fields" controlId="biddingdescription">
              ...
              ></Form.Control>
              {descriptionError && (
                <Message variant="danger">{descriptionError}</Message>
              )}
            </Form.Group>
